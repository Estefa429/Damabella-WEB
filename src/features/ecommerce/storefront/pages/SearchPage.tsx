                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto flex gap-2">
                    <button
                      ...
                      className="flex-grow bg-[#ec4899] text-white py-2 font-semibold text-xs hover:bg-[#db2777] transition-colors rounded cursor-pointer uppercase tracking-wider flex items-center justify-center text-center font-sans"
                    >
                      COMPRAR
                    </button>
                    <button
