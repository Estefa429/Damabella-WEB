          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                ...
                <p className="text-lg mb-4">Elegancia para cada ocasión</p>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                ...
                <p className="text-lg mb-4">Frescura y versatilidad</p>
                <button className="inline-flex items-center gap-2 text-white hover:gap-3 transition-all">
                  Explorar
                  <ArrowRight size={20} />
                </button>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                ...
                <p className="text-lg mb-4">Conjuntos perfectamente coordinados</p>
                <button className="inline-flex items-center gap-2 text-white hover:gap-3 transition-all">
                  Explorar
                  <ArrowRight size={20} />
                </button>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                ...
                <p className="text-lg mb-4">Sofisticación en una sola pieza</p>
                <button className="inline-flex items-center gap-2 text-white hover:gap-3 transition-all">
                  Explorar
                  <ArrowRight size={20} />
                </button>
